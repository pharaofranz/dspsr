...
#ifndef __dsp_UWBTwoBitUnpacker_h
#define __dsp_UWBTwoBitUnpacker_h

#include "dsp/HistUnpacker.h"

namespace dsp {
  
  class UWBTwoBitUnpacker : public HistUnpacker
  {
  public:

    //! Constructor
    UWBTwoBitUnpacker (const char* name = "UWBTwoBitUnpacker");
    ...
    //! Cloner (calls new)
    virtual UWBTwoBitUnpacker * clone () const;
